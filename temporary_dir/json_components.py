...
def get_enter_a_string():
    return '{"instanceNo":3,"change":{"type":"replace","definition":{"type":"Container","attributes":{"height":"flex","width":"flex"},"children":[{"type":"Container","attributes":{"height":"wrap","marginBottom":10,"marginLeft":5,"marginRight":5,"marginTop":5,"minWidth":"wrap","width":"flex"},"children":[{"type":"TextView","attributes":{"value":"Enter a string"}}]},{"type":"Container","attributes":{"direction":"horizontal","height":"wrap","marginBottom":2,"marginLeft":4,"marginRight":4,"marginTop":2,"valign":"middle","width":"flex"},"children":[{"type":"TextField","attributes":{"editorId":"v","hint":"Please enter a single line of text (this value is required)","hint-type":"info","mode":"enter","optional":false,"taskId":"3-0","value":null}},{"type":"Icon","attributes":{"hint":"Please enter a single line of text (this value is required)","hint-type":"info","iconCls":"icon-info","marginLeft":5,"tooltip":"Please enter a single line of text (this value is required)"}}]}]}}}'


def get_positive_number():
    return '{"instanceNo":5,"change":{"type":"replace","definition":{"type":"Panel","attributes":{"height":"flex","width":"flex"},"children":[{"type":"Container","attributes":{},"children":[{"type":"Container","attributes":{"height":"wrap","marginBottom":10,"marginLeft":5,"marginRight":5,"marginTop":5,"minWidth":"wrap","width":"flex"},"children":[{"type":"TextView","attributes":{"value":"Please enter a positive number"}}]},{"type":"Container","attributes":{"direction":"horizontal","height":"wrap","marginBottom":2,"marginLeft":4,"marginRight":4,"marginTop":2,"valign":"middle","width":"flex"},"children":[{"type":"IntegerField","attributes":{"editorId":"v","hint":"Please enter a whole number (this value is required)","hint-type":"info","mode":"enter","optional":false,"taskId":"2-1","value":null}},{"type":"Icon","attributes":{"hint":"Please enter a whole number (this value is required)","hint-type":"info","iconCls":"icon-info","marginLeft":5,"tooltip":"Please enter a whole number (this value is required)"}}]}]},{"type":"ButtonBar","attributes":{},"children":[{"type":"Button","attributes":{"actionId":"Ok","enabled":false,"iconCls":"icon-ok","taskId":"2-0","text":"Ok","value":"Ok"}}]}]}}}'
...
def get_buttonbar_two_buttons():
    return '{"instance":4,"change":{"type": "ButtonBar","attributes": {},"children": [{"type": "Button","attributes": {"actionId": "Ok","enabled": false,"iconCls": "icon-ok","taskId": "4-0","text": "Ok","value": "Ok"}},{"type": "Button","attributes": {"actionId": "Cancel","enabled": true,"iconCls": "icon-cancel","taskId": "4-0","text": "Cancel","value": "Cancel"}}]}}'


def get_buttonbar():
    return '{"instance":4,"change":{"type": "ButtonBar","attributes": {},"children": []}}'
...
def get_change_and_replace():
    return '{"instance":3,"change":{"type":"change","attributes":[],"children":[[1,"change",{"type": "replace","definition": {"type": "Panel", "attributes": {"height": "flex", "width": "flex"}, "children":[{"type": "Button","attributes": {"actionId": "Ok","enabled": false,"iconCls": "icon-ok","taskId": "4-0","text": "Ok","value": "Ok"}},{"type": "Button","attributes": {"actionId": "Cancel","enabled": true,"iconCls": "icon-cancel","taskId": "4-0","text": "Cancel","value": "Cancel"}}]}}],[2,"change",{"type":"change","attributes":[],"children":[[1,"change",{"type":"change","attributes":[],"children":[[1,"change",{"type":"change","attributes":[],"children":[[0,"change",{"type":"change","attributes":[{"name":"title","value":"Palindrome"}],"children":[]}]]}]]}]]}]]}}'
